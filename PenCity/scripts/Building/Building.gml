function Building(_name, _cost, _type, _sprite = noone, _citizens = 0, _radius = 0, _damage = 0, _profit = 0){
	return {
		name : _name,
		cost : _cost,
		...
		damage : _damage,
		pollution : 0,
		profit : _profit, // monthly profit from this building (e.g. factories)
		//event : -1
	};
}
